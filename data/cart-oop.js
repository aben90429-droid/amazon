function Cart(localStorageKey) {
  const cart = {
    ...
    cartItemss: undefined,

    loadFromStorage() {
      this.cartItemss = JSON.parse(localStorage.getItem(localStorageKey))
    ...
    savetostorage() {
      localStorage.setItem(localStorageKey, JSON.stringify(this.cartItemss));
    }
    ,
...
const anotherCart = Cart('another-cart');

anotherCart.loadFromStorage();
